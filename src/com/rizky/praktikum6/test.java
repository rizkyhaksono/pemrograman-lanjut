...
public class test {
    ...
    static void appendNum (int[]x) throws IOException {
        ...
        FileWriter w = new FileWriter("src/com/rizky/praktikum6/dbInt.txt", true);
    ...
    static void appendString (String[]x) throws IOException {
        ...
        FileWriter w = new FileWriter("src/com/rizky/praktikum6/dbString.txt", true);
    ...
    static void readData(String params) throws Exception {
        switch (params){
            case "number" -> {
                try {
                    FileReader readNumber = new FileReader("src/com/rizky/praktikum6/dbInt.txt");
            ...
            case "string" -> {
                try {
                    FileReader readString = new FileReader("src/com/rizky/praktikum6/dbString.txt");
