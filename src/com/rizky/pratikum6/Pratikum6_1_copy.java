...
//        System.out.println("1. String\n2. Int\n3. Exit");
        ...
        // check if user input string or int
        if (input == 1) {
            System.out.print("Masukkan jumlah data : ");
            int jumlah = scnInt.nextInt();
        ...
        switch (input) {
            ...
            case 3 -> {
                ...
                System.out.println("Klik untuk keluar...");
                System.exit(0);
            }
            default -> {
                /*
    ...
    public static void main(String[] args) throws IOException {
        Pratikum6_1_copy p6 = new Pratikum6_1_copy();
